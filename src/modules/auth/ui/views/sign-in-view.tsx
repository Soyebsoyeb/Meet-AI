  ...
  const onSubmit = (data: z.infer<typeof formSchema>) => {
    ...
    authClient.signIn.email(
      ...
      },
      {
        ...
        onError: ({ error }) => {
          setPending(false);
          setError(error.error.message || "Invalid email or password");
        },
      }
    );
  };
    ...
    <div className="flex flex-col gap-6">
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
          ...
          <div
            className="bg-radial from-sidebar-accent to-sidebar  relative hidden
...
export const SignUpView = () => {
  ...
  const [error, setError] = useState<string | null>(null); // Changed String to string
  const [pending, setPending] = useState(false);
  ...
  const onSocial = (provider: "github" | "google") => {
    ...
    authClient.signIn.social(
      // Make sure this matches your auth client API
      {
        provider: provider,
        callbackURL: "/",
      },
